...
class ServiceUuidReflectionTest {
    ...
    fun allListContainsEveryUuidProperty() {
        val uuidProperties = ServiceUuid::class.java.declaredFields
        ...
        assertEquals(
            uuidProperties.size,
            allUuids.size,
            "ServiceUuid.ALL (${allUuids.size}) is out of sync with declared Uuid properties (${uuidProperties.size}). " +
                "Properties: $uuidProperties"
        )
    }
}
