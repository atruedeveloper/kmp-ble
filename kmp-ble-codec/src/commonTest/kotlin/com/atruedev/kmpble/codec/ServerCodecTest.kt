...
class ServerCodecTest {
    ...
    private suspend fun connectedServer(): GattServer {
    ...
    fun notifyWithBleEncoder() = runTest {
        ...
        val records = (server as FakeGattServer).getNotifications()
    ...
    fun indicateWithBleEncoder() = runTest {
        ...
        val records = (server as FakeGattServer).getIndications()
        assertEquals(1, records.size)
